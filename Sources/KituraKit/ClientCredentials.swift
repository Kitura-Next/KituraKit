...
/**
 ...
 This client route mirrors a Kitura Codable route that implements [TypeSafeHTTPBasic](https://kitura-next.github.io/Kitura-CredentialsHTTP/Protocols/TypeSafeHTTPBasic.html) authentication to verify a users identity.
 ### Usage Example: ###
 ```swift
 struct User: Codable {
    let name: String
...
/**
 ...
 This client route mirrors a Kitura Codable route that implements [TypeSafeFacebookToken](https://kitura-next.github.io/Kitura-CredentialsFacebook/Protocols/TypeSafeFacebookToken.html) authentication to verify a users identity.
 ### Usage Example: ###
 ```swift
...
/**
 ...
 The struct is initialized with a token, which will be used to authenticate the user and generate their user profile.
 This client route mirrors a Kitura Codable route that implements [TypeSafeGoogleToken](https://kitura-next.github.io/Kitura-CredentialsGoogle/Protocols/TypeSafeGoogleToken.html) authentication to verify a users identity.
 ### Usage Example: ###
 ```swift
 struct User: ExampleProfile {
    let id: String
